...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_MarkdownHighlighter_t::offsetsAndSizes) + ofs), len
Q_CONSTINIT static const qt_meta_stringdata_MarkdownHighlighter_t qt_meta_stringdata_MarkdownHighlighter = {
    {
        QT_MOC_LITERAL(0, 19)   // "MarkdownHighlighter"
    },
    "MarkdownHighlighter"
};
...
Q_CONSTINIT static const uint qt_meta_data_MarkdownHighlighter[] = {
...
Q_CONSTINIT const QMetaObject MarkdownHighlighter::staticMetaObject = { {
    ...
    qt_meta_stringdata_MarkdownHighlighter.offsetsAndSizes,
    qt_meta_data_MarkdownHighlighter,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_MarkdownHighlighter_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<MarkdownHighlighter, std::true_type>
    >,
    nullptr
} };
