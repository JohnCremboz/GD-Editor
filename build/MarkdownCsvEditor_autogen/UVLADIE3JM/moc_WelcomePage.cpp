...
Q_CONSTINIT static const qt_meta_stringdata_WelcomePage_t qt_meta_stringdata_WelcomePage = {
    {
        ...
        QT_MOC_LITERAL(12, 12),  // "fileSelected"
        QT_MOC_LITERAL(25, 0),  // ""
...
void WelcomePage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (WelcomePage::*)(const QString & );
            if (_t _q_method = &WelcomePage::fileSelected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WelcomePage::fileSelected(const QString & _t1)
{
